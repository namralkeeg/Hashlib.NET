...
{
    /// <summary>
    /// A CRC-32 implementation of the <see cref="HashAlgorithm"/> class.
    /// </summary>
    /// <remarks>Uses the zlib CRC-32 algorithm by default.</remarks>
    public sealed class Crc32 : HashAlgorithm
    {
        #region Fields

        // Default to zlib's CRC32 polynomial
        ...
        /// <summary>
        /// Initializes a <see cref="Crc32"/> class.
        /// </summary>
        public Crc32()
        {
            HashSizeValue = 32;
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="Crc32"/> class.
        /// </summary>
        /// <returns>A new instance of an <see cref="Crc32"/> class.</returns>
        ...
        /// <summary>
        /// Initializes an instance of <see cref="Crc32"/> class.
        /// </summary>
        ...
        protected override void HashCore(byte[] array, int ibStart, int cbSize)
        {
            ...
            {
                crc = unchecked((crc >> 8) ^ _table[array[i] ^ ((byte)crc & 0xFF)]);
            }
        ...
        {
            // If the polynomial is the default use the pre-generated static table.
            if (polynomial == _DefaultPolynomial)
            {
                return _DefaultTable;
            }

            // Generate a tabel based on the provided polynomial.
